...
SELECT
  video_id,
  (0.1 * normalized_upload_time + 0.3 * decayed_normalized_likes + 0.2 * decayed_normalized_watches + 0.1 * RANDOM() + dancer_score_adjustment) AS score_1,
  (0.1 * normalized_upload_time + 0.3 * decayed_normalized_likes + 0.2 * decayed_normalized_watches + 0.1 * RANDOM() + dancer_score_adjustment) AS score_2,
  (0.1 * normalized_upload_time + 0.3 * decayed_normalized_likes + 0.2 * decayed_normalized_watches + 0.1 * RANDOM() + dancer_score_adjustment) AS score_3,
  (0.1 * normalized_upload_time + 0.3 * decayed_normalized_likes + 0.2 * decayed_normalized_watches + 0.1 * RANDOM() + dancer_score_adjustment) AS score_4,
  (0.1 * normalized_upload_time + 0.3 * decayed_normalized_likes + 0.2 * decayed_normalized_watches + 0.1 * RANDOM() + dancer_score_adjustment) AS score_5
