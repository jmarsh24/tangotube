...
ActiveRecord::Schema[7.0].define(version: 2022_03_25_131016) do
  ...
  create_table "videos", force: :cascade do |t|
    ...
    t.virtual "searchable", type: :text, as: "(COALESCE(title, ''::text) || (COALESCE(description, ''::character varying))::text)", stored: true
    ...
    t.index ["searchable"], name: "index_videos_on_searchable", opclass: :gist_trgm_ops, using: :gist
