...
RSpec.describe Import::Importer do
  ...
  let(:video_crawler) { Import::Crawler.new }
  let(:metadata_processor) { Import::MetadataProcessing::MetadataProcessor.new }
  let(:metadata) do
    Import::Metadata.new(
      youtube: Import::Youtube::VideoMetadata.new(
        ...
        comment_count: 50,
        like_count: 200,
        song: Import::Youtube::SongMetadata.new(
        ...
        thumbnail_url: Import::Youtube::ThumbnailUrl.new(
          default: "default_url",
          medium: "medium_url",
          high: "high_url",
      ...
      music: Import::MusicRecognition::Metadata.new(
