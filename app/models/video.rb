...
class Video < ApplicationRecord
  ...
  has_many :follower_roles, ->(_role) { where(role: :follower) }, class_name: "DancerVideo", dependent: :destroy
  has_many :leader_roles, ->(_role) { where(role: :leader) }, class_name: "DancerVideo", dependent: :destroy
