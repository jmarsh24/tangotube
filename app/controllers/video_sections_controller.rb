...
class VideoSectionsController < ApplicationController
  ...
  def recent
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked]}, sort: "most_recent", user: current_user).videos
  ...
  def older
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked]}, sort: "oldest", user: current_user).videos
      .has_dancer.not_hidden.from_active_channels
      .limit(36)
      .preload(Video.search_includes)
  end
  ...
  def performances
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked]}, sort: "performance", user: current_user).videos
      .has_dancer.not_hidden.from_active_channels
      .limit(36)
      .preload(Video.search_includes)
  end
  ...
  def event
    ...
    @event = @events.sample
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked], event: @event.slug, year: @year}, sort: "trending_5", user: current_user).videos
      .has_dancer.not_hidden.from_active_channels
      .limit(36)
      .preload(Video.search_includes)
  end
  ...
  def trending
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked]}, sort: "trending_5", user: current_user).videos
      .has_dancer.not_hidden.from_active_channels
      .limit(36)
      .preload(Video.search_includes)
  end
  ...
  def alternative
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked], genre: "alternative"}, user: current_user).videos
      .has_dancer.not_hidden.from_active_channels
      .limit(36)
      .preload(Video.search_includes)
  end
  ...
  def dancer
    ...
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked], dancer: @dancer.slug}, user: current_user).videos
  ...
  def song
    ...
    @song = @songs.sample
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked], song: @song.slug}, user: current_user).videos
      .has_leader.has_follower.not_hidden.from_active_channels
      .limit(36)
      .preload(Video.search_includes)
  end
  ...
  def channel
    ...
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked], channel: @channel.youtube_slug}, user: current_user).videos
      .has_leader.has_follower.not_hidden.from_active_channels
      .limit(36)
      .preload(Video.search_includes)
  end
  ...
  def orchestra
    ...
    @videos = Video::Search.new(filtering_params: {watched: params[:watched], liked: params[:liked], orchestra: @orchestra.slug}, user: current_user).videos
      .has_leader.has_follower.not_hidden.from_active_channels
      .limit(36)
      .preload(Video.search_includes)
  end
  ...
  def interview
    ...
    @videos = Video::Filter.new(interview_videos, filtering_params: {watched: params[:watched], liked: params[:liked]}, user: current_user).videos
      .has_dancer.not_hidden.from_active_channels
      .limit(500)
      .preload(Video.search_includes)
      .shuffle.take(36)
  ...
  def workshop
    ...
    @videos = Video::Filter.new(class_videos, filtering_params: {watched: params[:watched], liked: params[:liked]}, user: current_user).videos
  ...
  def mundial
    ...
    @videos = Video::Filter.new(mundial_videos, filtering_params: {watched: params[:watched], liked: params[:liked]}, user: current_user).videos
      .not_hidden.from_active_channels
      .limit(500)
      .preload(Video.search_includes)
      .shuffle.take(36)
