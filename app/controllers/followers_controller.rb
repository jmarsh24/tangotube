class FollowersController < ApplicationController
  ...
  def create
    @follower = Follower.create(name: "#{params[:follower][:first_name]} #{params[:follower][:last_name]}", first_name: params[:follower][:first_name], last_name: params[:follower][:last_name])
    fetch_new_follower
