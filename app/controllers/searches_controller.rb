...
class SearchesController < ApplicationController
  ...
  def new
    ...
    @recent_searches = current_user.recent_searches.unique_searches.limit(10) if current_user
  end
  ...
  def show
    ...
    ui.replace("search-results", with: "searches/recent_searches", recent_searches: current_user.recent_searches.unique_searches.limit(10)) unless params[:query].present?
